	...
	<main class="d-flex justify-content-center align-items-center h-75">
		<form style="width: 400px;" action="/user/regist" method="POST">
			...
			<div class="mb-3">
				...
				<button type="button" class="btn btn-primary" onclick="openJoin(); return false;">아이디 중복체크</button>
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="u_name" name="u_name" minlength="1" maxlength="20">
				<!-- name 셋팅을 해야 값이 넘어옴 -->
			</div>			
			<a href="/user/login" class="btn btn-primary text-light">취소</a>
			<button type="submit" class="btn btn-info text-light float-end">가입</button>
		</form>
	</main>
